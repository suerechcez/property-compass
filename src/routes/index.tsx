...
function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[560px] overflow-hidden bg-gradient-to-br from-primary/30 via-primary/10 to-background md:h-[640px]">
        {heroImageOk && (
          <img
            ...
            className="absolute inset-0 h-full w-full object-cover object-center animate-hero-image"
            loading="eager"
        ...
        {/* Hero copy — each element cascades in with a staggered delay */}
        <div className="relative flex h-full flex-col items-start justify-center px-6 pb-12 md:px-16 md:pb-16 lg:px-24">
          <h1
            className="max-w-2xl font-display text-4xl font-bold leading-tight text-white drop-shadow-lg md:text-6xl animate-reveal"
          ...
          <p
            className="mt-4 max-w-xl text-base text-white/85 drop-shadow md:text-lg animate-reveal"
          ...
          <form
            action="/browse"
            method="get"
            className="mt-8 flex w-full max-w-2xl items-center gap-3 rounded-2xl bg-white px-6 py-3 shadow-2xl shadow-black/30 md:py-4 animate-reveal"
          ...
          >
            ...
            <button
              type="submit"
              aria-label="Search"
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-foreground transition hover:bg-black/5 hover:scale-110 active:scale-95 md:h-12 md:w-12"
            >
      ...
      {/* ── Sign-in CTA ─────────────────────────────────────────────── */}
      {!loading && !user && (
        <section className="border-b border-border bg-surface animate-reveal" style={{ animationDelay: "100ms" }}>
          <div className="mx-auto max-w-2xl px-6 py-16 text-center">
            ...
            <Button asChild size="lg" className="mt-6 transition hover:scale-105 active:scale-95">
