    ...
    <div className="site-page">
      ...
      <section className="relative h-[560px] overflow-hidden bg-gradient-to-br from-primary/30 via-primary/10 to-background md:h-[640px]">
        ...
        <div className="relative flex h-full flex-col items-start justify-center px-6 pb-12 md:px-16 md:pb-16 lg:px-24">
          <h1 className="max-w-2xl animate-reveal font-display text-4xl font-bold leading-tight text-white drop-shadow-lg md:text-6xl">
            Bringing you home,{" "}
          ...
          <p className="mt-4 max-w-xl animate-reveal text-base text-white/85 drop-shadow md:text-lg" style={{ animationDelay: "80ms" }}>
          ...
          <form
            action="/browse"
            method="get"
            className="mt-8 flex w-full max-w-2xl animate-reveal items-center gap-3 rounded-2xl bg-white px-6 py-3 shadow-2xl shadow-black/30 md:py-4"
